              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                          ...
                          return AlertDialog(
                            actions: [
                              Container(
                                ...
                                child: Center(child: Text(Forget_Password_text.OK, style: TextStyle(color: AppColor.Full_body_color, fontWeight: FontWeight.w600))),
                              )
                            ],
                            ...
                            content: Container(
                              height: Get.height / 4,
                              width: Get.width,
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(Get.width / 50), color: AppColor.Full_body_color),
                              child: Column(
                                children: [
                                  ...
                                  Text(textAlign: TextAlign.center, Forget_Password_text.Sub_Suessess, style: TextStyle(fontWeight: FontWeight.w400, fontSize: Get.width / 28, color: AppColor.subcolor)),
                                ],
                              ),
                            ),
                          );
                    ...
                    child: OnButtons(Button_Color: AppColor.Button_color, btn_name: Forget_Password_text.Submit),
                  ),
